...
public static class RuntimePreviewGenerator
{
	...
	static RuntimePreviewGenerator()
	{
		...
		Padding = 0f;
		BackgroundColor = new Color( 0.3f, 0.3f, 0.3f, 0f );
	...
	public static Texture2D GenerateMaterialPreview( Material material, PrimitiveType previewObject, int width = 256, int height = 256)
	{
		return GenerateMaterialPreviewWithShader( material, previewObject, null, null, width, height );
	}

	public static Texture2D GenerateMaterialPreviewWithShader( Material material, PrimitiveType previewPrimitive, Shader shader, string replacementTag, int width = 256, int height = 256)
	{
	...
	public static Texture2D GenerateModelPreview( Transform model, int width = 256, int height = 256, bool shouldCloneModel = false )
	{
		return GenerateModelPreviewWithShader( model, null, null, width, height, shouldCloneModel );
	}

	public static Texture2D GenerateModelPreviewWithShader( Transform model, Shader shader, string replacementTag, int width = 256, int height = 256, bool shouldCloneModel = false )
	{
